...
class Teacher extends Component {
  ...
  refreshCourses = () => {
    this.props.app.getAxios(
      `/teachers/${this.props.match.params.id}/courses`,
      data => {
    ...
    if (this.props.app.teachers) {
      ...
      if (teacher) {
        ...
        privilege =
          ...
          this.props.match.params.id === this.props.app.teacherid;
              ...
              <Grid item sm={12} md={6} className="subpanel">
                <div id="teacherText">
                  <div>
                    ...
                    <HashLink
                      to={`/teachers#department-${departmentName}`}
                      style={{textDecoration: 'none'}}>
                  ...
                  {!privilege && <Divider style={{margin: '30px 0 10px 0'}} />}
                  {privilege && (
                    <div style={{marginBottom: '30px'}}>
                      <Link
                        to={`/teachers/${this.props.match.params.id}/edit`}
                        style={{textDecoration: 'none'}}>
                        <ButtonMaterial
                  ...
                  {courses.map(course => (
                    <Card
                      ...
                      <HashLink
                        to={`/courses#subject-${course.subject.name}`}
                        style={{textDecoration: 'none'}}>
                        <Card.Header
                          style={{
