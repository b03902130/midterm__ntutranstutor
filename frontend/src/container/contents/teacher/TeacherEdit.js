                        ...
                        this.state.submitted ?
                            ...
                            <div id="panel">
                                <Grid container direction="row" justify="space-evenly" alignItems="flex-start">
                                    ...
                                    <Grid item sm={12} md={6} className="subpanel">
                                        <div id="teacherText" style={{ marginTop: "25px" }}>
                                            <TextField
                                                id="nameEdit"
                                                label="教師名稱"
                                            ...
                                            <div style={{marginBottom: "30px"}}>
                                                ...
                                                <ButtonMaterial onClick={this.delete} variant="contained" style={{ border: "#f44336 1px solid", backgroundColor: "#f44336", padding: "0", marginLeft: "0px", marginTop: "12px" }}>
